...
public class FlightMapperTest {
    ...
    public void toEntityTest() {
        ...
        assertAll(
                ...
                () -> assertEquals(flightRequest.departureAirportCode(), mappedEntity.getDepartureAirportCode()),
                () -> assertEquals(flightRequest.destinationAirportCode(), mappedEntity.getDestinationAirportCode()),
                () -> assertEquals(flightRequest.departureTimeUtc(), mappedEntity.getDepartureTimeUtc()),
    ...
    public void toResponseTest() {
        ...
        assertAll(
                ...
                () -> assertEquals(flight.getDepartureAirportCode(), mappedResponse.departureAirportCode()),
                () -> assertEquals(flight.getDestinationAirportCode(), mappedResponse.destinationAirportCode()),
    ...
    public void udpateTest() {
        ...
        assertAll(
                ...
                () -> assertEquals(flight.getDepartureAirportCode(), flightRequest.departureAirportCode()),
                () -> assertEquals(flight.getDestinationAirportCode(), flightRequest.destinationAirportCode()),
